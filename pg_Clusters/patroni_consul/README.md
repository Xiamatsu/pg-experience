...
#### 4.5 Запуск Patroni на первом хосте
...
Patroni запустил сам PostgreSQL и создал новую базу<br>
Если в каталоге указанном как data_dir уже есть данные<br>
Они будут использоваться как начальные<br> 
- только версия (мажорная) СУБД и БД должны совпадать 
